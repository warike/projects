    ...
    func DatosPorFlota() -> Void
    {
        ...
        _manager.POST( url,
            ...
            success: { (operation: AFHTTPRequestOperation!,responseObject: AnyObject!) in
                ...
                if let vehiculos : NSArray = responseObject.objectForKey("DatoFlota") as? NSArray {
                    ...
                    NSNotificationCenter.defaultCenter().postNotificationName("actualizarFlotaVehiculos", object: self, userInfo: ["vehiculos": self._vehiculos])
                }
    ...
    func UltimaUbicacion(gps_id: String, patente_id: String, ilogin: String, ipassword: String)-> Void {
        ...
        _manager.POST( url,
            ...
            success: { (operation: AFHTTPRequestOperation!,responseObject: AnyObject!) in
                ...
                if let ubicaciones : NSArray = responseObject.objectForKey("ubicacion") as? NSArray {
                    ...
                    NSNotificationCenter.defaultCenter().postNotificationName("actualizarMapaUbicacion", object: self, userInfo: ["ubicacion": self._ubicaciones.last!])
                }
