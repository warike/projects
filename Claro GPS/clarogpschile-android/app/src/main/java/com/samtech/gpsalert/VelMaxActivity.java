...
import com.samtech.gpsalert.Adapters.AdapterListVelMax;
import com.samtech.gpsalert.Models.VelMaxModel;
...
*/
    ...
    // Permite cargar la lista de vehiculos para la velocidad maxima
    ...
    public class ActualizarVelocidadTask extends AsyncTask<Void, Void, String> {
        ...
        ActualizarVelocidadTask(String Usuario, String Password, ArrayList<VelMaxModel> v) {
            ...
            Psw = Password;
            listaActualizar = v;
            respuestasWS = new String[v.size()];
        }
