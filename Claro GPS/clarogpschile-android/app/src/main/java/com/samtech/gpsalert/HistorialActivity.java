...
import com.samtech.gpsalert.Models.HistorialModel;
...
public class HistorialActivity extends ActionBarActivity {
    ...
    // Carga el historial de un vehiculo
    public class HistorialTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            Log.d("HistorialWS", "ilogin="+ilogin+"&ipassword="+ipassword+"&id="+idVehiculo+"&patente="+Patente);
