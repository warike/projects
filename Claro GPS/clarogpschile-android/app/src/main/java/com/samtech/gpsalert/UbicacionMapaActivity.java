...
public class UbicacionMapaActivity extends ActionBarActivity {
    ...
    public String Usr, Psw, Usr_Lat, Usr_Lng, idVehiculo, Patente, GPS_Lat, GPS_Lng, app, dToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUbicacionGPS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (GPS_Lat != null && !GPS_Lat.isEmpty() && GPS_Lng != null && !GPS_Lng.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(), getString(R.string.error_no_ubicacion_GPS), Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnModoEstacionado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ModoEstacionadoTask meTask;
                if (flagModoEstacionado)
                    meTask = new ModoEstacionadoTask(Usr, Psw, idVehiculo, Patente, "0"); // String Usr, String Psw, String id, String pat, String est
                else
                    meTask = new ModoEstacionadoTask(Usr, Psw, idVehiculo, Patente, "1"); // String Usr, String Psw, String id, String pat, String est
...
*/
    ...
    public void recargarUbicaciones(){
        gestorGPS miGPS = new gestorGPS(UbicacionMapaActivity.this);
        if(miGPS.puedeObtenerUbicacion()){
            if(miGPS.obtenerLat()!=0.0 && miGPS.obtenerLng()!=0.0){
                if(Patente.compareToIgnoreCase("Todos los vehículos") == 0){
    ...
    public class UbicacionTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String Resultado){
            if(Resultado!=null){
                ...
                /*{"ubicacion":[{"latitud" : "-33.42434","longitud" : "-070.58130","patente" : "CAM02","velocidad" : "0",
                "fecha" : "02/09/2015","hora" : "14:19:00","chofer" : "No Asignado","ubicacion" : "A 0 Km. de Oficina Samtech Stgo.",
                "faena" : "Santiago","id" : "TJ00","sentido" : "157","estado" : "Apagado"}]}*/
                try {
