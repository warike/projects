...
public class MenuActivity extends Activity {
    int tipoUsr = 0, contador=0, estadoVeh = -1, estadoControlVelocidad = -1, estadoControldeUso = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView btnUbicacion = (ImageView) findViewById(R.id.btnUbicacion);
        ...
        // Accion del boton Historial
        ImageView btnHistorial = (ImageView) findViewById(R.id.btnHistorial);
        ...
        // Accion del boton Configuración
        ImageView btnNotificaciones = (ImageView) findViewById(R.id.btnNotificaciones);
    ...
    protected void onResume() {
        ...
        //// Cambiar el icono del menu si es que hay por lo menos un vehiculo con control de velocidad ////
        // Instanciando los botones
