...
import com.samtech.gpsalert.Adapters.AdapterListModoEstacionado;
                                ...
                                for(int i=0; i<jsonArr.length();i++){
                                    ...
                                    if (jsonVeh != null) {
                                        if(!jsonVeh.getString("ID").isEmpty() && !jsonVeh.getString("Patente").isEmpty()) {
                                            ModoEstacionadoModel m = new ModoEstacionadoModel(jsonVeh.getString("ID"), jsonVeh.getString("Patente"), jsonVeh.getString("Estado"), jsonVeh.getString("Velocidad"), jsonVeh.getString("Nombre"));
