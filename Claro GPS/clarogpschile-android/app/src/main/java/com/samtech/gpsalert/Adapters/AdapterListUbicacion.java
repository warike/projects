...
import com.samtech.gpsalert.UbicacionMapaActivity;
...
public class AdapterListUbicacion extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("ListUbic", position + "-" +listaVehiculos.get(position).getPatenteVehiculo());

        if(listaVehiculos.get(position).getPatenteVehiculo().compareToIgnoreCase("Todos los vehículos")==0 && position == 0){
