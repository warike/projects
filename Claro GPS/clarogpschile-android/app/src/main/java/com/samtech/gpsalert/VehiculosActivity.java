...
import com.samtech.gpsalert.Adapters.AdapterListNombreVehiculos;
...
public class VehiculosActivity extends ActionBarActivity {
        ...
        protected void onPostExecute(String Resultado) {
            if(Resultado!=null){
                ...
                if(listaVehiculos.size()>0){
                    ...
                    Log.d("VehiculosAct", listaVehiculos.size()+"<- TAMAÑO");
                }
                else {
    ...
    // Permite cambiar el nombre de los vehiculos
