...
import com.samtech.gpsalert.Adapters.AdapterListHistorial;
import com.samtech.gpsalert.Adapters.AdapterListVehiculos;
...
public class HistorialListActivity extends ActionBarActivity  implements OnQueryTextListener {
    String Usr, Psw;
    public ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vehiculos_lista);
        ...
        if(Usr.isEmpty() || Psw.isEmpty()) finish();
            ...
            ListaVehiculosTask lvt = new ListaVehiculosTask(Usr,Psw);
            lvt.execute((Void) null);
        }
        setearBarraSuperior();
    }
    ...
    public boolean onQueryTextChange(String stringIngresado) {
        AdapterListVehiculos adp = (AdapterListVehiculos) lv.getAdapter();
    ...
    public class ListaVehiculosTask extends AsyncTask<Void, Void, String> {
        private final String urlWS = "http://libs.samtech.cl/movil/ListaVehiculoTodos.asp";
        private final String Usr;
        private final String Psw;

        ListaVehiculosTask(String Usuario, String Password) {
            Usr = Usuario;
            Psw = Password;
        }
        ...
        protected void onPostExecute(String Resultado) {
            if(Resultado!=null){
                Log.d("HistorialListAct", Resultado);
                                ...
                                for(int i=0; i<jsonArr.length();i++){
                                    ...
                                    if (jsonVeh != null) {
                                        if(!jsonVeh.getString("ID").isEmpty() && !jsonVeh.getString("Patente").isEmpty()) {
                                            VehiculoModel v = new VehiculoModel(jsonVeh.getString("ID"), jsonVeh.getString("Patente"), jsonVeh.getString("Nombre"));
                ...
                if(listaVehiculos.size()>0){
                    AdapterListVehiculos adapter = new AdapterListVehiculos(getBaseContext(), Usr, Psw, listaVehiculos);
