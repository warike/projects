...
class ContactoViewController: UIViewController {
    ...
    @IBAction func borrarContacto(_ sender: AnyObject) {
        let titulo = "Alerta"
        ...
        if #available(iOS 8.0, *) {
            ...
            sosAlert.addButton(withTitle: btnCancelar)
            sosAlert.addButton(withTitle: btnOK)
            sosAlert.show()
        }
    }
    ...
    func respuestaActualizacion(_ notification: Notification) -> Void
    {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NotificationCenter.default.addObserver(self, selector:#selector(ContactoViewController.respuestaActualizacion(_:)), name: NSNotification.Name(rawValue: "respuestaActualizacion"), object: nil)
    ...
    func validarValores(_ nombre: String, numero: String, mail: String) -> Bool{
