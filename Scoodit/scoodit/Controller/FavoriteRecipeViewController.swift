...
//  scoodit
//
//  Created by Sergio Esteban on 23/03/17.
...
class FavoriteRecipeViewController: ButtonBarPagerTabStripViewController, ScooditHelper {
    ...
    override func viewWillAppear(_ animated: Bool) {
       self.navigationController?.navigationBar.barTintColor = scoodit_color
       self.navigationController?.navigationBar.backgroundColor = scoodit_menu_color
    }
